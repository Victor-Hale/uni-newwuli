...
class Student extends Model
{
    ...
    public  static  function zlcSelectStudent($student_id){
           ...
           $res=self::where("student_num",$student_id)
           ->leftjoin('danbai','student.student_num','danbai.student_id')
               ->leftjoin('experiment','student.student_num','experiment.student_id')
          ->select(
                  "student_name","student_num","student_level", "student_year","student_spec","student_class","experiment.state","danbai.state_danbai"
              )
           ->get();
        return $res;
